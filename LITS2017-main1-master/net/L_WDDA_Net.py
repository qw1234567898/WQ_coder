...
class L_WDDA_Net(nn.Module):
    def __init__(self, args):
        ...
        self.residual_conv1 = ResidualConv_CPCA(filters[0], filters[1], 2, 1)


        self.residual_conv2 = ResidualConv_CPCA(filters[1], filters[2], 2, 1)


        self.residual_conv3 = ResidualConv_CPCA(filters[2], filters[3], 2, 1)

        self.residual_conv4 = ResidualConv_CPCA(filters[3], filters[4], 2, 1)
